...
class TermController extends CoreController
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Term']))
		{
			...
			if($model->save())
            {
                Yii::app()->user->setFlash('success', 'Term "' . $model->term .'" saved!');
				$model=new Term;
            }
		}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Term']))
		{
			...
			if($model->save())
            {
				Yii::app()->user->setFlash('success', 'Term "' . $model->term .'" updated!');
	...
	public function actionDelete($id)
	{
        $model = $this->loadModel($id);
         ...
         Yii::app()->user->setFlash('success', 'Term "'. $model->term .'" deleted!');
